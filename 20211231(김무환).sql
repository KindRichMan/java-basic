-- employees를 사용 스키마로 지정해주세요.library
use employees;
...
birth_year int(4) not null, -- 정수 int뒤에 괄로넣지 않으면 숫자는 무한으로 사용.
...
-- 회원부터 집어넣있음.
INSERT INTO usertbl VALUES('kmh', '김무환',1986,'서울','01101010101', 180,'2021-03-07');
INSERT INTO usertbl VALUES('SHM', '손흥민',2002,'남원','01012124545', 173,'2020-09-02');
INSERT INTO usertbl VALUES('kyc', '김영철',1974,'상주','01178457845', 190,'1999-10-20');
SELECT * FROM userTbl;

-- 가입한 회원이 물건을 산 이력이 남도록 하겠습니다. 
INSERT INTO buyTbl VALUES(NULL,'kmh', '기계식키보드','주변기기', 200000,1);
-- order_number는 값을 null로 주면 AUTO_INCREMENT에 의해 자동으로 1씩 증가된 숫자를 배정받음
INSERT INTO buyTbl VALUES(NULL,'kmh', '듀얼모니티','주변기기', 20000,1);
-- 없는 회원 아이디로 INSERT를 시도해보겠습니다.

INSERT INTO buyTbl VALUES(null, 'SHM', '담배', '식품외', 5000, 10);
INSERT INTO buyTbl VALUES(null, 'kyc','k8', '자동차', 50000000,1);
SELECT * FROM buyTbl;
