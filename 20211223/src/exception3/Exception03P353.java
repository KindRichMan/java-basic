...
public class Exception03P353 {
	...
	public static void main(String[] args) {
		...
		//예외가 발생하지도 모르느 코드부터 try블럭에 넣습니다.
		try {
		...
		catch(Exception e) {//Exception이 가장 밑이다.
			//Exception e 는 만능처리구문으로 어떤 예외도 다 일괄적으로 처리해줍니다.
		System.out.println("예외가 발생했습니다.");
		}
		//ArithmeticaException도 특별 처리를 해 주세요.
		//0으로 나눌 수 없답니다. 라고 메세지가 남도록 해주세요.
